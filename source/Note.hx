	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?noteType:Int = 0, ?inCharter:Bool = false)
	{
		...
		switch (noteTypeCheck)
		{
			...
			if (noteType == 3)
			{
				...
				animation.addByPrefix('greenScroll', 'greendrunk0');
				animation.addByPrefix('redScroll', 'reddrunk0');
				animation.addByPrefix('blueScroll', 'bluedrunk0');
				animation.addByPrefix('purpleScroll', 'purpledrunk0');
