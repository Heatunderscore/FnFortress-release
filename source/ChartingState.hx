...
<<<<<<< HEAD
	var noteTypes:Array<String> = ['Normal', 'Disguise', 'Dad2', 'Dad1', 'Snoiper', 'Bonk', 'Fist', 'Drunk', 'Rocket'];
=======
	var noteTypes:Array<String> = ['Normal', 'Disguise', 'Dad2', 'Dad1', 'Snoiper', 'Rocket'];
